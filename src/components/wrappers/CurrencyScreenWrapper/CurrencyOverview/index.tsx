    ...
    return (
      <>
        ...
        <Row
          ...
          isColumn={isCollapse}
        >
          <Value symbol={currencySymbol} value={overviewData.availableLiquidity} color="dark" />
        </Row>
          ...
          <>
            ...
            >
              <div className="CurrencyOverview__rowWithDoubleValue">
                {overviewData.borrowingEnabled ? (
                  <>
                    <ValuePercent value={overviewData.depositApy} color="dark" />
                    {!!overviewData.avg30DaysLiquidityRate && !isCollapse && (
                      <ValuePercent
          ...
          <>
            ...
            >
              {overviewData.baseLTVasCollateral === 0 ? (
                ...
                <ValuePercent value={overviewData.baseLTVasCollateral} color="dark" />
              )}
            </Row>
            ...
            {!isCollapse && (
              ...
              >
                {overviewData.liquidationThreshold <= 0 ? (
                  ...
                  <ValuePercent value={overviewData.liquidationThreshold} color="dark" />
                )}
              </Row>
            )}
            ...
            {!isCollapse && (
              ...
              >
                {overviewData.liquidationBonus <= 0 ? (
                  ...
                  <ValuePercent value={overviewData.liquidationBonus} color="dark" />
                )}
              </Row>
            )}
          </>
          ...
          <>
            ...
            >
              {overviewData.stableBorrowRateEnabled ? (
                <ValuePercent value={overviewData.stableRate} color="dark" />
              ) : (
                <span className="CurrencyOverview__no-data">—</span>
              )}
            </Row>
            ...
            >
              <div className="CurrencyOverview__rowWithDoubleValue">
                <ValuePercent value={overviewData.variableRate} color="dark" />
                {!!overviewData.avg30DaysVariableRate && !isCollapse && (
                  <ValuePercent
    ...
    >
      <div className="CurrencyOverview__content">
        <div className="CurrencyOverview__content-left">
          <div className="CurrencyOverview__content-left-caption">
          ...
          <div className="CurrencyOverview__content-left-content">
            {isCollapse || sm ? (
              <LeftInformation />
            ) : (
        ...
        <div className="CurrencyOverview__content-right">
          <div className="CurrencyOverview__content-right-caption">
            <Link
          ...
          <div className="CurrencyOverview__content-right-content">
            {!isCollapse && (
              <div
