...
import { GetBalanceOfMGL } from '../../../../libs/mgl-contract';
...
function DepositAmount({
  ...
  const [balanceOfMGL, setBalanceOfMGL] = useState("0")

  if (userId) {
    GetBalanceOfMGL(userId).then(result => {
      setBalanceOfMGL(result.toString(10));
    });
  }
