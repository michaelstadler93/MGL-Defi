  ...
  return (
    <div className="ReserveInformation">
      ...
      <ContentWrapper className="ReserveInformation__content">
        <div className="ReserveInformation__inner-title">
          <div className="ReserveInformation__title">{intl.formatMessage(messages.caption)}</div>
          ...
          <div className="ReserveInformation__APY-info">
            <APYCard title={intl.formatMessage(defaultMessages.deposit)} color="none">
              <APYLine
            ...
            <APYCard title={intl.formatMessage(messages.stableBorrowing)} color="none">
              <APYLine
            ...
            <APYCard title={intl.formatMessage(messages.variableBorrowing)} color="none">
              <APYLine
                title={intl.formatMessage(messages.borrowAPY)}
